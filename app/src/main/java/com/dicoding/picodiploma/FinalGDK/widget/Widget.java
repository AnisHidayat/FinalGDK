...
public class Widget extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        views.setRemoteAdapter(R.id.stackView_id,  intent);
        views.setEmptyView(R.id.stackView_id, R.id.empty_view_id);
        ...
        views.setPendingIntentTemplate(R.id.stackView_id, toastPendingIntent);
